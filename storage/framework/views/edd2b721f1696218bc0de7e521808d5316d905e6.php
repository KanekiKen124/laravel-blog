            ...
            <div class="col-lg-8">
              <div class="all-blog-posts">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="main-button">
                      <a href="<?php echo e(route('article.all')); ?>">View All Posts</a>
                    </div>
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\denis-blog\resources\views/home.blade.php ENDPATH**/ ?>